            ...
            <div class="overflow-hidden rounded-[28px] border border-[#eadfbe] bg-white shadow-sm">
                <div class="border-b border-[#f0e6ca] bg-gradient-to-r from-[#fffaf0] to-[#fffdf8] px-4 py-5 sm:px-6">
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div class="min-w-0">
                            <p class="text-[11px] uppercase tracking-[0.24em] text-[#b89a4c]">Content Management</p>
                            <h1 class="text-[28px] font-bold leading-tight text-slate-900">Edit About Us Record</h1>
                            <p class="mt-1 text-sm text-slate-500">
                                Update bilingual content and SEO details for this About Us entry.
                            </p>
                        </div>
                ...
                <form action="{{ route('admin.about-us.update', $aboutUs->id) }}" method="POST" class="space-y-6 p-4 sm:p-6">
                    @method('PUT')
                    @include('admin.about-us._form', ['submitLabel' => 'Update About Us'])
                </form>
            </div>
        </div>
    </section>
