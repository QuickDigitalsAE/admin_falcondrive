    ...
    <section class="w-full pb-8">
        <div class="mx-auto w-full max-w-7xl">
            <div class="overflow-hidden rounded-[28px] border border-[#eadfbe] bg-white shadow-sm">
                <div class="border-b border-[#f0e6ca] bg-gradient-to-r from-[#fffaf0] to-[#fffdf8] px-4 py-5 sm:px-6">
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div class="min-w-0">
                            ...
                            <h1 class="text-[28px] font-bold leading-tight text-slate-900">Add About Us Record</h1>
                            <p class="mt-1 text-sm text-slate-500">
                                Create bilingual About Us content, mission, vision, and SEO metadata.
                            </p>
                        </div>
                ...
                <form action="{{ route('admin.about-us.store') }}" method="POST" class="space-y-6 p-4 sm:p-6">
                    @include('admin.about-us._form', ['aboutUs' => null, 'submitLabel' => 'Save About Us'])
                </form>
            </div>
        </div>
    </section>
