            ...
            <div class="p-4 sm:p-6">
                <div class="rounded-[24px] border border-[#eadfbe] bg-white p-5 shadow-sm">
                    <div class="mb-5">
                        ...
                        <p class="mt-1 text-sm text-slate-500">City, price and type details.</p>
                    </div>
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
                        <div class="rounded-2xl border border-[#f0e6ca] bg-[#fffdf8] p-4"><p class="text-xs font-semibold uppercase tracking-[0.18em] text-[#b89a4c]">City</p><p class="mt-2 text-sm font-semibold text-slate-900">{{ $location->city ?: 'N/A' }}</p></div>
