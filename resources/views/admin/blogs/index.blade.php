...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function actionsHtml(blog) {
        ...
        if (permissions.can_edit) buttons.push(`<a href="${blog.edit_url}" class="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-[#d9c68f] bg-[#fff5d8] text-[#9b7a28] transition hover:bg-[#ffefc1]" title="Edit"><i class="fa-solid fa-pen text-[13px]"></i></a>`);
