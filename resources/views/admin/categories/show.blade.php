...
@section('content')
                        ...
                        <div class="xl:col-span-1">
                            <div class="rounded-[24px] border border-[#eadfbe] bg-gradient-to-br from-[#fffaf0] to-[#fffefb] p-5">
                                <div class="flex flex-col items-center text-center">
                                    <div class="h-28 w-28 overflow-hidden rounded-3xl border border-[#eadfbe] bg-white shadow-sm ring-4 ring-[#fbf2d6]"><img src="{{ $category->image_url ?: 'https://ui-avatars.com/api/?name=' . urlencode($category->name_en ?? 'Category') . '&background=F8E8B2&color=5E450A&size=200' }}" alt="{{ $category->name_en }}" class="h-full w-full object-cover"></div>
                        ...
                        <div class="xl:col-span-2">
                            <div class="rounded-[24px] border border-[#eadfbe] bg-white p-5 shadow-sm">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div class="rounded-2xl border border-[#f0e6ca] bg-[#fffdf8] p-4 sm:col-span-2"><p class="text-xs font-semibold uppercase tracking-[0.18em] text-[#b89a4c]">Category Image</p><p class="mt-2 text-sm font-semibold text-slate-900">{{ $category->image_url ?: 'N/A' }}</p></div>
    ...
    @include('admin.layouts.partials.super-admin-audit-card', ['record' => $category])
@endsection
