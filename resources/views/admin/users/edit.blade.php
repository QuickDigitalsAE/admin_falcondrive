                ...
                <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="flex flex-col gap-5 lg:flex-row lg:items-center">
                            <div class="flex shrink-0 items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-slate-500">
                                        Upload a new JPG, PNG, or WEBP image for the user avatar.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="rounded-[22px] border border-dashed border-slate-200 bg-slate-50/70 px-4 py-4 sm:px-5">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="min-w-0">
                                <h3 class="text-sm font-semibold text-slate-800">Before updating</h3>
                                <p class="mt-1 text-sm text-slate-500">
                                    Make sure role, email, status and profile image are correct. Only fill password if you
                                    want to change it.
                                </p>
                            </div>
                        </div>
            ...
            if (profileInput) {
                profileInput.addEventListener('change', function (event) {
                    ...
                    if (!file) {
                        ...
                        fileName.textContent = '{{ $user->profile_image_url ? basename($user->profile_image_url) : 'No file selected' }}';
                        return;
                    }
