...
@section('breadcrumbs')
    <nav class="flex flex-wrap items-center gap-2 text-[12px] text-slate-500">
        ...
        <i class="fas fa-chevron-right text-[10px] text-slate-400"></i>
        <span class="font-medium text-slate-700">Create User</span>
    </nav>
@endsection
                ...
                <div class="border-b border-[#f0e6ca] bg-gradient-to-r from-[#fffaf0] to-[#fffdf8] px-4 py-5 sm:px-6">
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div class="min-w-0">
                            ...
                            <h1 class="text-[28px] font-bold leading-tight text-slate-900">Add New User</h1>
                            <p class="mt-1 text-sm text-slate-500">
                                Create a new user account with role, profile image, login credentials, and status.
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-3">
                        ...
                        <div class="min-w-0">
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-2 px-1">
                                    <p class="text-xs text-slate-500">Enter the user’s full display name</p>
                        ...
                        <div class="min-w-0">
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-2 px-1">
                                    <p class="text-xs text-slate-500">Used for login, communication and system alerts</p>
                                    <span class="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#b4861f]">Required</span>
                                </div>
                        ...
                        <div class="min-w-0">
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-2 px-1">
                                    <p class="text-xs text-slate-500">Assign a role from the roles table</p>
                                    <span class="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#b4861f]">Required</span>
                                </div>
                        ...
                        <div class="min-w-0">
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-2 px-1">
                                    <p class="text-xs text-slate-500">Choose a strong secure password</p>
                                    <span class="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#b4861f]">Required</span>
                                </div>
                            ...
                            <div class="flex shrink-0 items-center gap-4">
                                <div id="profilePreviewWrapper"
                                    ...
                                    <img id="profilePreview"
                                        src="https://ui-avatars.com/api/?name=User&background=F8E8B2&color=5E450A&size=200"
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const defaultPreview = 'https://ui-avatars.com/api/?name=User&background=F8E8B2&color=5E450A&size=200';
