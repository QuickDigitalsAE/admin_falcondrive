    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div class="min-w-0">
                ...
                <p class="mt-1 text-sm text-slate-500">Manage all users</p>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-12">
                ...
                <div class="md:col-span-4 flex items-end gap-2">
                    <button type="button" id="searchBtn"
                        class="w-full rounded-xl bg-slate-900 px-4 py-3 text-sm font-medium text-white transition hover:bg-slate-800 inline-flex items-center justify-center">
