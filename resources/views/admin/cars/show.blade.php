                    ...
                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-[1.1fr_0.9fr]">
                        ...
                        <div class="space-y-5">
                            <div class="rounded-[24px] border border-[#eadfbe] bg-gradient-to-br from-[#fffaf0] to-[#fffefb] p-5">
                                ...
                                <div class="mt-4 grid grid-cols-2 gap-3 text-sm">
                                    <div class="rounded-2xl border border-[#eadfbe] bg-white p-4"><p class="text-xs uppercase tracking-[0.18em] text-slate-400">Full Insurance Daily</p><p class="mt-1 font-semibold text-slate-800">{{ $car->full_insurance_daily ?: 'N/A' }}</p></div>
                                    <div class="rounded-2xl border border-[#eadfbe] bg-white p-4"><p class="text-xs uppercase tracking-[0.18em] text-slate-400">Full Insurance Weekly</p><p class="mt-1 font-semibold text-slate-800">{{ $car->full_insurance_weekly ?: 'N/A' }}</p></div>
                                    <div class="rounded-2xl border border-[#eadfbe] bg-white p-4"><p class="text-xs uppercase tracking-[0.18em] text-slate-400">Full Insurance Monthly</p><p class="mt-1 font-semibold text-slate-800">{{ $car->full_insurance_monthly ?: 'N/A' }}</p></div>
                                    ...
                                    <div class="rounded-2xl border border-[#eadfbe] bg-white p-4"><p class="text-xs uppercase tracking-[0.18em] text-slate-400">Baby Seat Daily</p><p class="mt-1 font-semibold text-slate-800">{{ $car->baby_seat_daily ?: 'N/A' }}</p></div>
                                    <div class="rounded-2xl border border-[#eadfbe] bg-white p-4"><p class="text-xs uppercase tracking-[0.18em] text-slate-400">Baby Seat Weekly</p><p class="mt-1 font-semibold text-slate-800">{{ $car->baby_seat_weekly ?: 'N/A' }}</p></div>
                                    <div class="rounded-2xl border border-[#eadfbe] bg-white p-4"><p class="text-xs uppercase tracking-[0.18em] text-slate-400">Baby Seat Monthly</p><p class="mt-1 font-semibold text-slate-800">{{ $car->baby_seat_monthly ?: 'N/A' }}</p></div>
                                    ...
                                    <div class="rounded-2xl border border-[#eadfbe] bg-white p-4"><p class="text-xs uppercase tracking-[0.18em] text-slate-400">Waiver Daily</p><p class="mt-1 font-semibold text-slate-800">{{ $car->waiver_daily ?: 'N/A' }}</p></div>
                                    <div class="rounded-2xl border border-[#eadfbe] bg-white p-4"><p class="text-xs uppercase tracking-[0.18em] text-slate-400">Waiver Weekly</p><p class="mt-1 font-semibold text-slate-800">{{ $car->waiver_weekly ?: 'N/A' }}</p></div>
                                    <div class="rounded-2xl border border-[#eadfbe] bg-white p-4"><p class="text-xs uppercase tracking-[0.18em] text-slate-400">Waiver Monthly</p><p class="mt-1 font-semibold text-slate-800">{{ $car->waiver_monthly ?: 'N/A' }}</p></div>
