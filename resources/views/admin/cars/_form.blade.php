...
<div class="grid grid-cols-1 gap-5 xl:grid-cols-3">
    ...
    <div class="xl:col-span-3">
        ...
        <div class="grid grid-cols-1 gap-5 xl:grid-cols-3">
            @foreach ([
                ['id' => 'full_insurance_amount', 'label' => 'Full Insurance Amount', 'value' => old('full_insurance_amount', $car?->full_insurance_amount ?? '')],
                ...
                ['id' => 'baby_seat_amount', 'label' => 'Baby Seat Amount', 'value' => old('baby_seat_amount', $car?->baby_seat_amount ?? '')],
                ['id' => 'deposit_amount', 'label' => 'Deposit Amount', 'value' => old('deposit_amount', $car?->deposit_amount ?? '')],
                ['id' => 'waiver_amount', 'label' => 'Waiver Amount', 'value' => old('waiver_amount', $car?->waiver_amount ?? '')],
