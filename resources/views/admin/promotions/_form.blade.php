    ...
    <div class="flex flex-col gap-5 lg:flex-row lg:items-center">
        <div class="flex shrink-0 items-center gap-4">
            <div class="flex h-24 w-24 items-center justify-center overflow-hidden rounded-2xl border border-dashed border-[#d8c79d] bg-white shadow-sm">
                <img id="promotionPreview" src="{{ $promotion->image_url ?? 'https://placehold.co/200x200/f8e8b2/5e450a?text=Promotion' }}" alt="Promotion Preview" class="h-full w-full object-cover">
            </div>
            <div>
        ...
        <div class="flex-1">
            ...
            <div class="mt-3"><span id="fileName" class="rounded-full bg-white px-3 py-1 text-xs font-medium text-slate-500 shadow-sm ring-1 ring-[#eadfbe]">{{ $promotion->image ? basename($promotion->image) : 'No file selected' }}</span></div>
