...
class CarResource extends BaseResource
{
    public function toArray(Request $request): array
    {
        $data = [
            ...
            'full_insurance_daily' => $this->full_insurance_daily,
            'full_insurance_weekly' => $this->full_insurance_weekly,
            'full_insurance_monthly' => $this->full_insurance_monthly,
            'additional_driver_amount' => $this->additional_driver_amount,
            'baby_seat_daily' => $this->baby_seat_daily,
            'baby_seat_weekly' => $this->baby_seat_weekly,
            'baby_seat_monthly' => $this->baby_seat_monthly,
            'deposit_amount' => $this->deposit_amount,
            'waiver_daily' => $this->waiver_daily,
            'waiver_weekly' => $this->waiver_weekly,
            'waiver_monthly' => $this->waiver_monthly,
