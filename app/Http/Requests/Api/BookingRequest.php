...
class BookingRequest extends BaseDataRequest
{
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'delivery_custom_address' => $this->sanitizeLongText($this->input('delivery_custom_address')),
            ...
            'pickup_location_id' => $this->sanitizeInteger($this->input('pickup_location_id')),
            ...
            'vehicle_group_id' => $this->sanitizeInteger($this->input('vehicle_group_id')),
            'tariff_group_id' => $this->sanitizeInteger($this->input('tariff_group_id')),
    ...
    public function rules(?Model $model = null): array
    {
        return [
            ...
            'delivery_custom_address' => ['nullable', 'string', 'max:5000'],
            ...
            'vehicle_group_id' => ['nullable', 'integer', 'min:1'],
            'tariff_group_id' => ['nullable', 'integer', 'min:1'],
